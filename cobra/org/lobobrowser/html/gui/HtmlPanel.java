 ...
 */
public class HtmlPanel extends JComponent implements FrameContext,Printable {
	 ...
	 */
	public HtmlPanel(MainFrame frame) {
		super();
	...
	public SelectionDispatch getSelectionDispatch() {
		return (SelectionDispatch) selectionDispatch;
	}
