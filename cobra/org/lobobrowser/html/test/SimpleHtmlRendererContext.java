...
public class SimpleHtmlRendererContext implements HtmlRendererContext {
	...
	public void linkClicked(HTMLElement linkNode, URL url, String target) {
		...
		SelectionChangeEvent event = new SelectionChangeEvent(htmlPanel, true);
		...
		htmlPanel.getSelectionDispatch().fireEvent(event);
	}
	...
	public void navigate(final URL href, String target) {
		...
		if (href.toString() != null) {
			htmlPanel.getFrame().getHistoryPanel().addAddress(href.toString());
			htmlPanel.getFrame().getHistoryPanel().refresh();
			htmlPanel.getFrame().getHistoryPanel().repaint();
		}
	...
	public void setBack(boolean backed) {
		this.back = backed;
	}
